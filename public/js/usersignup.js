...
function handleRoleChange(selectElement) {
    ...
    if (selectedOption === 'employee') {
      ...
      document.getElementById('employee').setAttribute('required',true);
      document.getElementById('dept').setAttribute('required',true);
    } else if (selectedOption === 'vendor') {
      employeeFields.style.display = 'none';
      vendorFields.style.display = 'block';
      document.getElementById('vendor').setAttribute('required', true);
	  document.getElementById('employee').removeAttribute('required');
